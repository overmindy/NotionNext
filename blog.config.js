...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是Elainay,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Elainay', // 您的昵称 例如 tangly1024
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,qq,email,messenger,reddit', // 分享的服務，按顺序显示,逗号隔开
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Elainay\'s blog', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
